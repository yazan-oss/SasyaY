...
/// </summary>
public abstract class BaseShot : UbhMonoBehaviour
{
    ...
    private Shooting m_shotCtrl;

    public Shooting shotCtrl
    {
        get
        {
            if (m_shotCtrl == null)
            {
                m_shotCtrl = GetComponentInParent<Shooting>();
            }
            return m_shotCtrl;
        }
    }
    ...
    /// UbhShotCtrl setter.
    /// </summary>
    public void SetShotCtrl(Shooting shotCtrl)
    {
        m_shotCtrl = shotCtrl;
    }
