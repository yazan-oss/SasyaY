...
public class Bullet : UbhMonoBehaviour
{
    private Transform m_transformCache;
    private BaseShot m_parentBaseShot;
    ...
    public BaseShot parentShot { get { return m_parentBaseShot; } }
    ...
    /// Bullet Shot
    /// </summary>
    public void Shot(BaseShot parentBaseShot,
